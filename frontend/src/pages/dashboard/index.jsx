...
//   })
           ...
           <div className={styles.scrollComponent}>
            ...
            <div className={styles.createPostComponent}>
             <img className={styles.userProfile}  src={`${BASE_URL}/${authState.user.userId.profilePicture}`} alt="profile" /> 
               <textarea onChange={(e)=>setPostContent(e.target.value)} value={postContent} placeholder='whats in your mind ?' className={styles.textarea}></textarea>
                  <label htmlFor="file">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                  ...
                  <input onChange={(e)=>setFileContent(e.target.files[0])} type="file" hidden id='file' />
                          ...
                          <img className={styles.userProfile} src={`${BASE_URL}/${authState.user.userId.profilePicture}`} alt="" />  
                            ...
                            <div>
                                ...
                                <div style={{display:"flex",gap:"0.6rem",justifyContent:"space-between"}}>
                                      ...
                                      <p style={{fontWeight:'bold',marginTop:'-7px'}}>{post.userId.name}</p>  
                                  
                                  {
                                    post.userId._id === authState.user.userId._id &&
                                     ...
                                     <svg style={{height:"1.2em",color:"red",marginTop:'-5px' }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                            ...
                            <p style={{color:'gray'}}>{post.userId.email}</p> 
               ...
               <div  onClick={(e)=>{
                ...
                className={styles.allCurrentContainer}>
                   ...
                   <div>
                    {postState.comments.map((comment,index)=>{
                       return (
                        ...
                        <div className={styles.singleCard} key={comment._id}>
                            <div className={styles.singleCard_profileContainer}>
                  ...
                  <div className={styles.postCommentContainer}>
                    ...
                    }}  className={styles.postCommentContainer_commentButton }>
